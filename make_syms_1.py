...
for kind in range(kinds):
    ...
    for i in range(place_relation):
        ...
        # create a variable called current_num as a proxy to num_taken for use in the loop so that
        # the value of num_taken can be adjusted in the body of the loop itself.
